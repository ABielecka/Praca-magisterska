...
\begin{tabularx}{\linewidth}{p{6cm}X}
		&{\fontsize{16pt}{18pt}\selectfont PROWADZĄCY PRACĘ:}\\[4mm] %UWAGA: tutaj jest miejsce na nazwisko promotora pracy
...
%%  Metadane dokumentu 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Rozpoznawanie niebezpiecznych sytuacji na drodze i uszkodzeń nawierzchni \\ z wykorzystaniem głębokich sieci neuronowych}
\titleShort{Rozpoznawanie niebezpiecznych sytuacji z wykorzystaniem sieci neuronowych}
\titleEN{Recognition of traffic hazards and road surface damages using deep neural networks}
\author{Anna Bielecka}
\uczelnia{POLITECHNIKA WROCŁAWSKA}
\wydzial{WYDZIAŁ ELEKTRONIKI, FOTONIKI \\ I MIKROSYSTEMÓW}
\kierunek{Automatyka i Robotyka (AIR)}
\specjalnosc{Technologie informacyjne w systemach automatyki (ART)}
\promotor{Dr hab. inż. Andrzej Rusiecki \textcolor{white}{ TO NEW LINE} Katedra Informatyki Technicznej}
\date{WROCŁAW, 2022}
